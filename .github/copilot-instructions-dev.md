We are going to build a Node MCP server for the Jeopardy Archive site. Use the Cheerio package to scrape content from the site, turning it into an API for the MCP server.
